<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="holidayRedesign.WebForm2" %>
        ...
        <form runat="server" id="form1">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="DropDownList9" runat="server" CssClass="form-control">
                    <asp:ListItem>Please select.......</asp:ListItem>
                    <asp:ListItem>Meds Customer Care</asp:ListItem>
                    <asp:ListItem>Managing Director</asp:ListItem>
                    <asp:ListItem>FIT UK (London office)</asp:ListItem>
                    <asp:ListItem>Contracting Uk</asp:ListItem>
                    <asp:ListItem>Operations UK</asp:ListItem>
                    <asp:ListItem>FIT UK (Edinburgh office)</asp:ListItem>
                    <asp:ListItem>Customer Care Intl Mkts Edinburgh</asp:ListItem>
                    <asp:ListItem>Customer Care Meds Edinburgh</asp:ListItem>
                    <asp:ListItem>Customer Care German/Nordics Edin</asp:ListItem>
                    <asp:ListItem>Accommodation (Edinburgh office)</asp:ListItem>
                    <asp:ListItem>Accommodation Director</asp:ListItem>
                    <asp:ListItem>Customer Care Director</asp:ListItem>
                    <asp:ListItem>Accounts</asp:ListItem>
                </asp:DropDownList>
            </div>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DropDownList9" ErrorMessage="*Please choose your department" InitialValue="Please select......."></asp:RequiredFieldValidator>
